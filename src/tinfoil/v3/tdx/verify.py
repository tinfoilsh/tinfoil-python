...
def _verify_response(
    ...
    # go-tdx-guest anchors the header root via chain verification to the
    # trusted root; this byte-equality pin is an added, stricter check (also
    # present in tinfoil-js). Without it the CRL below would be validated
    # against a root the chain check never saw.
